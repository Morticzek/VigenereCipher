...
public class VigenereServletDecryption extends HttpServlet {
            ...
            throws IOException, ServletException
    {
        ...
        VigenereModel vigenereModel = new VigenereModel(message, keyword, false, true);
        vigenereModel.vigenereDecryption(message, keyword);
